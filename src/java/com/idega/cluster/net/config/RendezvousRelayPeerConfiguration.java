/*
 * $Id: RendezvousRelayPeerConfiguration.java,v 1.1 2007/01/25 09:25:13 thomas Exp $
...
public class RendezvousRelayPeerConfiguration {
	...
	*/
    ...
    public static void createPlatformConfig(IWApplicationContext iwac) {
    	...
    	prepareJxtaHome(jxtaHome);
      	...
      	String peerName = productInfo.getName();
   		...
   		new RendezvousRelayPeerConfiguration(peerName, "password", "secretpassword", jxtaHome, iwac);
    }
	...
	public RendezvousRelayPeerConfiguration(String peerName, String id, String password, File jxtaHome, IWApplicationContext iwac) {
        ...
        try{
            ...
            for (int i = 0;i < list.size();i++){
                ...
                if (list.get(i) instanceof net.jxta.ext.config.HttpTransport){
                    ...
                    // enable HTTP
                    httpData.setEnabled(true);
                    
                    // disable outgoing
                    httpData.setOutgoing(false);
                    
                    // enable incoming
                    httpData.setIncoming(true);
